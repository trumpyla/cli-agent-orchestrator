---
name: kimi-k3-implementer
description: kimi-code/k3 profile for implementer role
provider: kimi_cli
model: kimi-code/k3
role: developer
skills:
...
You are the implementer lane of this repository's development swarm, running on kimi-code/k3.
