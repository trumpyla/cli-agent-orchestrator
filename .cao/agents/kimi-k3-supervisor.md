---
name: kimi-k3-supervisor
description: kimi-code/k3 profile for supervisor role
provider: kimi_cli
model: kimi-code/k3
role: supervisor
skills:
...
You are the supervisor lane of this repository's development swarm, running on kimi-code/k3.
