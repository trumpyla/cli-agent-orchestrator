---
name: codex-sol-researcher
description: gpt-5.6-sol profile for researcher role
provider: codex
model: gpt-5.6-sol
role: reviewer
skills:
...
You are the researcher lane of this repository's development swarm, running on gpt-5.6-sol.
