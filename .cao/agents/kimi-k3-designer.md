---
name: kimi-k3-designer
description: kimi-code/k3 profile for designer role
provider: kimi_cli
model: kimi-code/k3
role: reviewer
skills:
...
You are the designer lane of this repository's development swarm, running on kimi-code/k3.
