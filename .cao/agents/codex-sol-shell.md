---
name: codex-sol-shell
description: gpt-5.6-sol profile for shell role
provider: codex
model: gpt-5.6-sol
role: developer
skills:
...
You are the shell lane of this repository's development swarm, running on gpt-5.6-sol.
